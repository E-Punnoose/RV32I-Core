module msrv32_integer_file(
    ...
    begin
        ...
        else if (wr_en_in && rd_addr_in != 5'b0)
        begin
            reg_file[rd_addr_in] <= rd_in;
        end
    end

    assign rs_1_out = (rs_1_addr_in == 5'b0) ? 32'b0 :
                       fwd_op1_enable         ? rd_in  : reg_file[rs_1_addr_in];

    assign rs_2_out = (rs_2_addr_in == 5'b0) ? 32'b0 :
                       fwd_op2_enable         ? rd_in  : reg_file[rs_2_addr_in];
